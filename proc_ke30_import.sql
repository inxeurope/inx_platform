...
ALTER PROCEDURE [dbo].[_ke30_import]
...
BEGIN
    ...
    BEGIN TRY
        BEGIN TRANSACTION
            -- This procedure takes the minimum and maximum date from the ke 30 import table in the form YYYYMM
            -- The proc remove fro the ke30 table all line between (including) min and max dates
            -- The proc copy from the import table to the ke30 table
            -- The proc keeps a log of messages in the #ProcedureLog temporary table and returns these lines at the end
            -- Everything is encapsulated in a transation
            ...
            -- The following are managed by the django app now
